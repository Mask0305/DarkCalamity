    ...
    <div id="wrap">
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <!-- Branding -->
          <?php require "includes/branding.inc.php"; ?>
        <!--Branding end-->
          ...
          <div class="navbar-collapse">
            ...
            <!-- Quick Actions -->
            <?php require "includes/quick_action.inc.php";?>
            <!-- /Quick Actions -->
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="tile-body color transparent-black rounded-corners">
                    ...
                    <div class="table-responsive">
                      <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
                          <tr>
                            <th class="sort-numeric">關卡編號</th>
                            <th class="sort-alpha">關卡名稱</th>
                            <th class="sort-alpha">難易度</th>
                            <th class="sort-amount">完成度</th>
                            <th class="">掉落物件</th>
                            <th class="text-right" style="width:6em">戰鬥次數</th>
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td>村長的手套、村長的頭盔、迪雷德爾草、史萊姆殘渣、破舊布</td>
                ...
                <section class="tile transparent">
                  <!-- tile header -->
                  <div class="tile-header transparent">
                    <h1><strong>Drill-down rows</strong> Datatable </h1>
                    <span class="note">including: <span class="italic">col reorder with resize</span></span>
                    <div class="controls">
                      <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
