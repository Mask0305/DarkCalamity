...
<ul class="nav navbar-nav side-nav" id="sidebar">
  ...
  <li class="navigation" id="navigation">
    <a href="#" class="sidebar-toggle" data-toggle="#navigation">選單 <i class="fa fa-angle-up"></i></a>

    <ul class="menu">

      <li class="active">
        <a href="index.php">
          <i class="fas fa-jedi"></i> 首頁
...
<!-- 略-->
    ...
    <li>
      <a href="battle.php">
        <i class="fab fa-battle-net"></i> 戰役
      </a>
    </li>
    <li>
      <a href="status.php">
        <i class="fas fa-user"></i> 狀態
      </a>
    </li>
    <li>
      <a href="bag.php">
    ...
    <li>
      <a href="produce.php">
        <i class="fas fa-bezier-curve"></i> 製作
      </a>
    </li>
     <li>
      <a href="strengthen.php">
        <i class="fas fa-hammer"></i></i> 強化
      </a>
    </li>
    <li>
      <a href="mission.php">
        <i class="fas fa-clipboard-list"></i> 任務
      </a>
    </li>
    <li>
      <a href="shop.php">
        <i class="fab fa-phoenix-framework"></i> 商店
      </a>
    </li>
    <li>
      <a href="duel.php">
        <i class="fab fa-d-and-d"></i> 決鬥場
      </a>
    </li>
      <!-- <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
  ...
  <li class="summary" id="order-summary">
    <a href="#" class="sidebar-toggle underline" data-toggle="#order-summary">本周決鬥場狀態<i class="fa fa-angle-up"></i></a>
